# MovieGit Documentation

Product and engineering documentation for [MovieGit](../README.md). The README covers what the product is and how to use it; these documents cover why it's built the way it is.
...
| [Changelog](../CHANGELOG.md) | Everything that's shipped, dated, with the reasoning behind the larger changes |

Start with the [PRD](PRD.md) if you're new to the project; start with [Architecture](ARCHITECTURE.md) if you're here to read code.
